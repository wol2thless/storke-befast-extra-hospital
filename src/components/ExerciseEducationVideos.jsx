...
const videos = [
  {
    ...
    src: "https://www.youtube.com/embed/ls0ZUehgiMA",
  },
  {
    title:
      "การออกกำลังกายด้วยตัวเองในผู้ปวยโรคหลอดเลือดสมอง l งานกายภาพบำบัด โรงพยาบาลราชวิถี",
    src: "https://www.youtube.com/embed/eEmeOHis4bE",
  },
  {
    title:
      "การจัดท่านอนหงายและการพลิกตะแคงตัวในผู้ป่วยโรคหลอดเลือดสมอง l งานกายภาพบำบัด โรงพยาบาลราชวิถี",
    src: "https://www.youtube.com/embed/LU1XdGeOwIA",
  },
  {
    title:
      "การเคลื่อนไหวข้อต่อโดยญาติ/ผู้ดูแลในผู้ป่วยโรคหลอดเลือดสมอง l งานกายภาพบำบัด โรงพยาบาลราชวิถี",
    src: "https://www.youtube.com/embed/6zgNn1alhIM",
  },
  {
    title: "การออกกำลังกาย สำหรับผู้ป่วยโรคหลอดเลือดสมองที่บ้าน",
    src: "https://www.youtube.com/embed/5Fv59zZ9h0w",
  },
  {
    title: "การฝึกพูดสำหรับผู้ป่วยโรคหลอดเลือดสมอง",
    src: "hhttps://www.youtube.com/embed/_fG04RU1kJg",
  },
  {
    title:
      "10 ท่า ทรงตัวมั่นคง ยืนเดินปลอดภัย l งานกายภาพบำบัด โรงพยาบาลราชวิถี",
    src: "https://www.youtube.com/embed/PAG5s56afcU",
  },
];

function ExerciseEducationVideos({ hideTitle }) {
  ...
  const getViewCount = (videoId) => {
    const found = stats.find((s) => s.video_id === String(videoId)); // ใช้ videoId โดยตรง ไม่ต้องบวก 99
    if (!found) return 0;
    ...
    <div className="mt-0">
      {!hideTitle && (
        <h2 className="text-lg font-bold mb-2 text-primary">
          วิดีโอออกกำลังกาย/กายภาพบำบัดสำหรับผู้ป่วย
        </h2>
      )}

      {/* คำแนะนำด้านบน */}
      <div className="bg-success/10 border border-success/20 rounded-lg p-4 mb-4">
        <h3 className="font-semibold text-success mb-2">💪 คำแนะนำ</h3>
        <p className="text-sm text-base-content/80 leading-relaxed">
          การออกกำลังกายที่เหมาะสมช่วยฟื้นฟูร่างกายและเสริมสร้างความแข็งแรงให้ผู้ป่วยโรคหลอดเลือดสมอง
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-red-500 font-bold">
                  ดูแล้ว {getViewCount(i + 100)} ครั้ง
                </span>
                <button
                  onClick={() =>
                    openVideo(v.src.replace("/embed/", "/watch?v="), i + 100)
                  }
...
export default ExerciseEducationVideos;
