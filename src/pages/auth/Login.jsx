import { FaBrain, FaBook } from "react-icons/fa";
...
const Login = () => {
  ...
  const handleLoginThaiD = () => {
    const client_id = import.meta.env.VITE_THAID_CLIENT_ID;
  ...
  return (
    <div className="min-h-[70vh] flex flex-col justify-center items-center px-4">
      <div className="w-full max-w-xs bg-base-100 rounded-xl shadow-lg p-6 flex flex-col items-center">
        ...
        {import.meta.env.VITE_ASSESSMENT_FORM_URL && (
          <div className="mt-6 w-full">
            <a
              href={import.meta.env.VITE_ASSESSMENT_FORM_URL}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <button
          ...
          onClick={() => (window.location.href = (import.meta.env.VITE_BASE_PATH || "/stroke-befast") + "/admin/login")}
        >
